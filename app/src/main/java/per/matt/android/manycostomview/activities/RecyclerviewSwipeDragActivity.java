...
public class RecyclerviewSwipeDragActivity extends AppCompatActivity {
    ...
    private OnItemMoveListener onItemMoveListener = new OnItemMoveListener() {
        ...
        public void onItemDismiss(RecyclerView.ViewHolder srcHolder) {
            ...
            if (recyclerview.getHeaderCount() > 0 && adapterPosition == 0) { // HeaderView。
                ...
                Toast.makeText(RecyclerviewSwipeDragActivity.this, "HeaderView被删除。", Toast.LENGTH_SHORT).show();
            } else { // 普通Item。
                mList.remove(position);
                mAdapter.notifyItemRemoved(position);
                Toast.makeText(RecyclerviewSwipeDragActivity.this, "现在的第" + position + "条被删除。", Toast.LENGTH_SHORT).show();
            }
        }
    };
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState == OnItemStateChangedListener.ACTION_STATE_DRAG) {
                ...
                viewHolder.itemView.setBackgroundColor(
                        ContextCompat.getColor(RecyclerviewSwipeDragActivity.this, R.color.white_pressed));
                ...
                ViewCompat.setBackground(viewHolder.itemView,
                        ContextCompat.getDrawable(RecyclerviewSwipeDragActivity.this, R.drawable.select_white));
            }
        }
    };
