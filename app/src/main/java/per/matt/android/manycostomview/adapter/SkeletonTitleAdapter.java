...
public class SkeletonTitleAdapter extends RecyclerView.Adapter<SkeletonTitleAdapter.ReportViewHolder> {
    ...
    public ReportViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_skeleton, parent, false);
