...
public class TitleNoLineAdapter extends RecyclerView.Adapter<TitleNoLineAdapter.ReportViewHolder> {

    private List<String> mList;

    public TitleNoLineAdapter(List<String> list) {
        this.mList = list;
    }

    @Override
    public ReportViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_title_noline, parent, false);
